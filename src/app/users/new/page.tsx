                ...
                <CardContent>
                    <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="col-span-2">
                            ...
                            <Input id="name-new" name="name" value={user.name} onChange={handleChange} placeholder="Ex: Maria Oliveira" />
                        </div>

                        <div>
                            <Label htmlFor="email-new">E-mail</Label>
                            <Input id="email-new" name="email" type="email" value={user.email} onChange={handleChange} placeholder="maria@email.com" />
                        </div>

                        <div>
                            <Label htmlFor="whatsapp-new">WhatsApp</Label>
                            <Input id="whatsapp-new" name="whatsapp" type="tel" value={user.whatsapp} onChange={handleChange} placeholder="(62) 99877-6655" />
                        </div>
